...
def load_production_model():
    ...
    try:
        # In cloud deployment, model files need to be included in repo
        ...
        for model_file in model_files:
            if os.path.exists(model_file):
                ...
                model_type = "Linear Regression" if "linear" in model_file else "Random Forest"
                return model, None, model_type
        
        return None, "Production model files not found in deployment", "Unknown"
    except Exception as e:
        return None, f"Error loading model: {str(e)}", "Unknown"
